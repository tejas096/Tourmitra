        ...
        <div className="card">
          <div className="cardprofile">
            ...
            <div className="cardimage">
              <img
                src="https://images.unsplash.com/photo-1468218457742-ee484fe2fe4c?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="cardbody">
            ...
            <p>
              <span className="det">City:</span> Visakhapatnam, Vijayawada,
              Amaravati, Guntur, Kurnool
            </p>
            <p>
              <span className="det">Contact:</span> ayushsingh@tourmitra.com
            </p>
            <p>
