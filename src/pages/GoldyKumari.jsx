        ...
        <div className="card">
          <div className="cardprofile">
            ...
            <div className="cardimage">
              <img
                src="https://plus.unsplash.com/premium_photo-1682089810582-f7b200217b67?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="cardbody">
            ...
            <p>
              <span className="det">City:</span> Patna, Darbhanga, Gaya
            </p>
            <p>
              <span className="det">Contact:</span> goldy@tourmitra.com
            </p>
            <p>
