      ...
      <div className="cardcontainer">
        <div className="card">
          ...
          <div className="cardbody">
            ...
            <p>
              <span className="det">City:</span> Fort Aguada, Baga Beech,
              Arambol Beech
            </p>
            <p>
              <span className="det">Contact:</span> HimanshuMeena@tourmitra.com
            </p>
            <p>
