        ...
        <div className="card">
          <div className="cardprofile">
            ...
            <div className="cardimage">
              <img
                src="https://static.india.com/wp-content/uploads/2021/12/pjimage-39-5.jpg?impolicy=Medium_Widthonly&w=700"
          ...
          <div className="cardbody">
            ...
            <p>
              <span className="det">City:</span> Surat, Ahmedabad, Navrati
            </p>
            <p>
              <span className="det">Contact:</span> JethalalGada@tourmitra.com
            </p>
            <p>
