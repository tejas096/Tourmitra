        ...
        <div className="card">
          <div className="cardprofile">
            ...
            <div className="cardimage">
              <img
                src="https://images.unsplash.com/photo-1591980896142-4e36328411ec?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="cardbody">
            ...
            <p>
              <span className="det">City:</span>Raipur, Bhilai, korba
            </p>
            <p>
              <span className="det">Contact:</span> radhamishra@tourmitra.com
            </p>
            <p>
